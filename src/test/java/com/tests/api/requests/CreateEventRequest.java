...
/** Body for {@code POST /events} and {@code PUT /events/{id}}. {@code price} is a JSON number on the request side, unlike {@link com.tests.api.responses.EventResponse#price()} which the API returns as a string (verified live - see Phase 7 summary). */
