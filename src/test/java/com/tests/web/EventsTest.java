...
public class EventsTest {
    ...
    public void logInAndGoToEvents() {
        ...
        // clickLogin() deliberately does not wait for the async login API call to
        // complete (see its Javadoc). Navigating away before it does would abandon
        // the pending request and load the next URL unauthenticated - which here
        // just redirects straight back to /login. Waiting for the logged-in nav
        // first is what actually confirms the login succeeded.
        HomePage homePage = new HomePage();
        assertTrue(homePage.isDisplayed(), "Login should complete before navigating to /events.");
